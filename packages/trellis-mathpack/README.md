...
> **Status: scaffold (Part 4 #2).** Package structure, packaging metadata, and
> the entry point are in place. The function implementations land next
> (Part 4 #3-#5). See `../../design.md` → *Part 4: trellis-mathpack*.
