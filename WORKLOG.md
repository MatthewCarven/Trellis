...
**Next pick-up:** Part 6 row #4 — TUI selection model (Shift+arrows, Ctrl+A, Esc, delta-paint, range readout, Delete clears selection). Then #5 internal clipboard, #6 cut + OS bridge, #7 docs. Push pending from Windows (main 11 ahead).
